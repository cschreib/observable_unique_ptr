...
SUITE {
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment converting operator valid to empty", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment converting operator empty to valid", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment converting operator empty to empty", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment converting operator valid to valid", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment operator self to self valid", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer move assignment operator self to self empty", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
