...
SUITE {
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer comparison valid vs valid different instance", "[comparison][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer comparison valid vs valid different instance derived", "[comparison][observer]",
        owner_types) {
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer comparison valid vs valid same instance derived", "[comparison][observer]",
        owner_types) {
        if constexpr (has_base<TestType>) {
            memory_tracker mem_track;
