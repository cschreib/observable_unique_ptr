...
SUITE {
    TEMPLATE_LIST_TEST_CASE(
        "observer from owner assignment operator valid to empty", "[assignment][observer]",
        owner_types) {
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer from owner assignment operator empty to valid", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer from owner assignment operator empty to empty", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer from owner assignment operator valid to valid", "[assignment][observer]",
        owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        ...
        "[assignment][observer]", owner_types) {
        memory_tracker mem_track;
