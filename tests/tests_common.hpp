...
struct test_deleter {
    ...
    explicit test_deleter(int state) noexcept : state_(state) {
        ++instances_deleter;
    }
    ...
    void operator()(test_object_thrower* ptr) noexcept {
        delete ptr;
    }
...
using test_ptr_from_this_non_virtual = oup::basic_observable_ptr<
    test_object_observer_from_this_non_virtual_unique,
    oup::default_delete,
    unique_non_virtual_policy>;
...
using test_optr_from_this_derived =
    oup::observer_ptr<test_object_observer_from_this_derived_unique>;
using test_optr_from_this_derived_const =
    oup::observer_ptr<const test_object_observer_from_this_derived_unique>;
using test_optr_from_this_multi = oup::observer_ptr<test_object_observer_from_this_multi_unique>;
using test_optr_from_this_multi_const =
    oup::observer_ptr<const test_object_observer_from_this_multi_unique>;
using test_optr_from_this_sealed = oup::observer_ptr<test_object_observer_from_this_sealed>;
using test_optr_from_this_const_sealed =
    oup::observer_ptr<const test_object_observer_from_this_sealed>;
using test_optr_from_this_non_virtual_unique =
...
using test_optr_from_this_const_virtual_sealed =
    oup::observer_ptr<const test_object_observer_from_this_virtual_sealed>;
using test_optr_from_this_derived_sealed =
    oup::observer_ptr<test_object_observer_from_this_derived_sealed>;
using test_optr_from_this_derived_const_sealed =
    oup::observer_ptr<const test_object_observer_from_this_derived_sealed>;
using test_optr_from_this_multi_sealed =
    oup::observer_ptr<test_object_observer_from_this_multi_sealed>;
using test_optr_from_this_multi_const_sealed =
    oup::observer_ptr<const test_object_observer_from_this_multi_sealed>;
