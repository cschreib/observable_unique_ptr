...
SUITE {
    TEMPLATE_LIST_TEST_CASE(
        "observer static_cast move from valid", "[cast][observer]", owner_types) {
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer static_cast move from empty", "[cast][observer]", owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer const_cast move from valid", "[cast][observer]", owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer const_cast move from empty", "[cast][observer]", owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer dynamic_cast move from valid", "[cast][observer]", owner_types) {
        memory_tracker mem_track;
    ...
    TEMPLATE_LIST_TEST_CASE(
        "observer dynamic_cast move from empty", "[cast][observer]", owner_types) {
        memory_tracker mem_track;
